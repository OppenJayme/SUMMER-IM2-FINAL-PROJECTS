    ...
    return (
        <div>
            <div className="inventory-card" onClick={onInspect}>
                ...
                <div className="table-box"><p>{item.product_t.product_quantity} {item.product_t.quantity_status === 'low' && (<i style={{ color: 'red' }} className="bi bi-exclamation-triangle-fill"></i>)}</p></div>
                <div className="table-box"><p>{item.productSale} / {item.product_t.initial_quantity}(Initial Quantity)</p></div>
